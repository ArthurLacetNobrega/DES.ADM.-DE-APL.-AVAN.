package com.arthurlacet.avaliacao.service;

import com.arthurlacet.avaliacao.model.Aluno;
import com.arthurlacet.avaliacao.repository.AlunoRepository;
...
public class AlunoService {
    ...
    public List<Aluno> findByalunocurso(String nome, String curso) {
        if (nome == null) {
            nome = "";
        }
        if (curso == null) {
